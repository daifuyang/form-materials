...
exports.useEditor = exports.WORD_EDITOR_INITIALIZING = exports.INITIAL_OPTIONS = void 0;
...
var WORD_EDITOR_INITIALIZING = CURRENT_LANGUAGE === 'en-US' ? 'Initializing Editor' : '编辑器初始化中';
exports.WORD_EDITOR_INITIALIZING = WORD_EDITOR_INITIALIZING;
var INITIAL_OPTIONS = {
  fontSize: 12,
  tabSize: 2,
...
var useEditor = function useEditor(type, props) {
  ...
  var languageRef = (0, _react.useRef)(language || 'text');
  var pathRef = (0, _react.useRef)(path);
  var previousPath = usePrevious(path);
  var requireConfigRef = (0, _react.useRef)(props.requireConfig);
  var optionRef = (0, _react.useRef)(props.options);
  var monacoRef = (0, _react.useRef)();
  var editorRef = (0, _react.useRef)();
  var containerRef = (0, _react.useRef)();
  var typeRef = (0, _react.useRef)(type);
  var editorDidMountRef = (0, _react.useRef)();
  var editorWillMountRef = (0, _react.useRef)();
  var decomposeRef = (0, _react.useRef)(false);
  var viewStatusRef = (0, _react.useRef)(new Map());
  var enhancersRef = (0, _react.useRef)({});
  ...
  }, [defaultValue]); // make sure loader / editor only init once

  (0, _react.useEffect)(function () {
    setLoading(true);
    (0, _monaco.getMonaco)(requireConfigRef.current).then(function (monaco) {
      ...
      if (typeRef.current === 'single') {
        ...
        editor = monaco.editor.create(containerRef.current, (0, _extends2["default"])({
          automaticLayout: true
        ...
        editor = monaco.editor.createDiffEditor(containerRef.current, (0, _extends2["default"])({
          automaticLayout: true
  ...
  }, [isEditorReady, theme]); // focus status
  ...
  }, [isEditorReady, type]); // decomposing status
  ...
  }, [isEditorReady, path, type, value]); // multi-model && controlled value (shouldn't be diff mode)
