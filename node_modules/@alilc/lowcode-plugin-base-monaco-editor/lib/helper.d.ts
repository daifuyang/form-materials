 ...
 */
export declare type IEditorInstance = oEditor.IStandaloneCodeEditor | oEditor.IStandaloneDiffEditor;
export declare type EditorEnhancer = (monaco: Monaco, editorIns: IEditorInstance) => any;
