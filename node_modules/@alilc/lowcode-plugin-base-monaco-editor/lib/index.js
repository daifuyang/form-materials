...
var _exportNames = {
  SingleMonacoEditorComponent: true
};
exports["default"] = exports.SingleMonacoEditorComponent = void 0;
...
Object.keys(_monaco).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _monaco[key]) return;
  exports[key] = _monaco[key];
});
...
var SingleMonacoEditor = function SingleMonacoEditor(props) {
  ...
  var _useEditor = (0, _helper.useEditor)('single', props),
  ...
  var subscriptionRef = (0, React.useRef)(null);
  var className = (0, _classnames["default"])('lc-code-control', props.className, {
    've-focused': focused,
    've-outline': enableOutline
  });
  var fullScreenClassName = (0, _classnames["default"])({
  ...
  (0, React.useEffect)(function () {
    return function () {
      ...
      editorInstance === null || editorInstance === void 0 ? void 0 : (_editorInstance$getMo = editorInstance.getModel()) === null || _editorInstance$getMo === void 0 ? void 0 : _editorInstance$getMo.dispose(); // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  var fullScreen = function fullScreen() {
    ...
    if (!isFullScreen) {
      ...
      editorInstance === null || editorInstance === void 0 ? void 0 : editorInstance.updateOptions((0, _extends2["default"])({}, editorInstance === null || editorInstance === void 0 ? void 0 : editorInstance.getOptions(), {
        minimap: {
          enabled: true
        }
      }));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "loading"
  }, _helper.WORD_EDITOR_INITIALIZING), /*#__PURE__*/React.createElement("div", {
    ref: containerRef,
...
var DiffMonacoEditor = function DiffMonacoEditor(props) {
  ...
  var _useEditor2 = (0, _helper.useEditor)('diff', props),
  ...
  (0, React.useEffect)(function () {
    return function () {
      ...
      (_editorRef$current4 = editorRef.current) === null || _editorRef$current4 === void 0 ? void 0 : (_editorRef$current4$g = _editorRef$current4.getModel().modified) === null || _editorRef$current4$g === void 0 ? void 0 : _editorRef$current4$g.dispose(); // eslint-disable-next-line react-hooks/exhaustive-deps
...
var DiffMonacoEditorComponent = Object.assign(DiffMonacoEditor, {
  ...
  defaultProps: {
    ...
    defaultValue: '',
    language: 'javascript',
    options: _helper.INITIAL_OPTIONS,
    editorDidMount: noop,
...
var SingleMonacoEditorComponent = Object.assign(SingleMonacoEditor, {
...
exports.SingleMonacoEditorComponent = SingleMonacoEditorComponent;
var _default = SingleMonacoEditorComponent;
