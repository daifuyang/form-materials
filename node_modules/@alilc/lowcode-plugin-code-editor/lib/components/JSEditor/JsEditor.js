...
var JsEditor = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(JsEditor, _PureComponent);
  function JsEditor() {
    ...
    _this.state = {
      errorInfo: null,
      hasError: false,
      code: (_this$props$jsCode = _this.props.jsCode) !== null && _this$props$jsCode !== void 0 ? _this$props$jsCode : _config.defaultCode
    };
    _this.monaco = void 0;
  ...
  _proto.getSchemaFromCode = function getSchemaFromCode() {
    ...
    var ast = (0, _utils.transformAst)(code);
    var _getMethods = (0, _utils.getMethods)(ast),
    ...
    if (Object.keys(errorsByMethods).length > 0) {
      _dialog["default"].alert({
        ...
        content: /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, _config.WORDS.functionParseError, Object.entries(errorsByMethods).map(function (_ref, index) {
          var key = _ref[0],
            err = _ref[1];
    ...
    return {
      state: (0, _utils.stateParser)(ast),
      methods: newMethods,
  ...
  _proto.editorDidMount = /*#__PURE__*/function () {
    var _editorDidMount = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(monaco, editor) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_tab["default"], {
      size: "small",
      shape: "wrapped",
      activeKey: currentTab
    }, /*#__PURE__*/_react["default"].createElement(_tab["default"].Item, {
      className: hasError ? 'tab-with-error' : '',
      title: /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, code !== jsCode ? '* ' : '', "index.js"),
      key: _config.TAB_KEY.JS,
      onClick: function onClick() {
        return onTabChange(_config.TAB_KEY.JS);
      }
    })), currentTab === _config.TAB_KEY.JS && /*#__PURE__*/_react["default"].createElement("div", {
    ...
    }), hasError && typeof errorInfo === 'string' ? /*#__PURE__*/_react["default"].createElement(_ErrorTip.ErrorTip, {
      errorInfo: errorInfo
    }) : null));
  };
  _proto._updateCode = function _updateCode(newCode) {
    var _this4 = this;
    var _transformJS = (0, _utils.transformJS)(newCode, _config.defaultBabelConfig),
