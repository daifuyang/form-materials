  ...
  return _class = /*#__PURE__*/function (_Component) {
    ...
    function BaseRenderer(_props2, context) {
      ...
      _this.__executeLifeCycleMethod = function (method, args) {
        executeLifeCycleMethod((0, _assertThisInitialized2["default"])(_this), _this.props.__schema, method, args, _this.props.thisRequiredInJSE);
      };
      /**
      ...
      _this.__bindCustomMethods = function (props) {
        ...
        (0, _utils.forEach)(__schema.methods, function (val, key) {
          ...
          if ((0, _lowcodeUtils.isJSExpression)(value) || (0, _lowcodeUtils.isJSFunction)(value)) {
            value = _this.__parseExpression(value, (0, _assertThisInitialized2["default"])(_this));
          }
          if (typeof value !== 'function') {
            console.error("custom method " + key + " can not be parsed to a valid function", value);
            return;
          }
          _this[key] = value.bind((0, _assertThisInitialized2["default"])(_this));
        });
      };
        ...
        if (useDataSourceEngine) {
          _this.__dataHelper = {
            updateConfig: function updateConfig(updateDataSource) {
              var _createDataSourceEngi = (0, _interpret.create)(updateDataSource !== null && updateDataSource !== void 0 ? updateDataSource : {}, (0, _assertThisInitialized2["default"])(_this), props.__appHelper.requestHandlersMap ? {
          ...
          _this.__dataHelper = new _utils.DataHelper((0, _assertThisInitialized2["default"])(_this), dataSource, appHelper, function (config) {
      ...
      _this.__render = function () {
        ...
        if (engine) {
          engine.props.onCompGetCtx(schema, (0, _assertThisInitialized2["default"])(_this));
      ...
      _this.__createDom = function () {
        ...
        var scope = {};
        scope.__proto__ = __ctx || (0, _assertThisInitialized2["default"])(_this);
      ...
      _this.__createVirtualDom = function (originalSchema, originalScope, parentInfo, idx) {
        ...
        try {
          ...
          if (!Comp) {
            ...
            console.error(schema.componentName + " component is not found in components list! component list is:", components || ((_this$props$__contain3 = _this.props.__container) === null || _this$props$__contain3 === void 0 ? void 0 : _this$props$__contain3.components));
          ...
          _this.__componentHOCs.forEach(function (ComponentConstruct) {
            Comp = ComponentConstruct(Comp, {
              ...
              baseRenderer: (0, _assertThisInitialized2["default"])(_this),
              scope: scope
            });
          });

          // 对于不可以接收到 ref 的组件需要做特殊处理
          if (!(0, _utils.canAcceptsRef)(Comp)) {
            Comp = (0, _hoc.compWrapper)(Comp);
          ...
          var child = _this.__getSchemaChildrenVirtualDom(schema, scope, Comp);
      ...
      _this.__getSchemaChildrenVirtualDom = function (schema, scope, Comp) {
        var children = getSchemaChildren(schema);
      ...
      _this.__renderContextProvider = function (customProps, children) {
        return createElement(AppContext.Provider, {
          value: (0, _extends2["default"])({}, _this.context, {
            blockContext: (0, _assertThisInitialized2["default"])(_this)
          }, customProps || {}),
    ...
    BaseRenderer.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
      return executeLifeCycleMethod(this, props === null || props === void 0 ? void 0 : props.__schema, 'getDerivedStateFromProps', [props, state], props.thisRequiredInJSE);
    };
    ...
    return BaseRenderer;
  }(Component), _class.displayName = 'BaseRenderer', _class.defaultProps = {
    __schema: {}
  }, _class.contextType = AppContext, _class;
}