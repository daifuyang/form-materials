...
export declare type ISchema = IPublicTypeNodeSchema | IPublicTypeRootSchema;
...
export declare type IGeneralConstructor<T = {
    [key: string]: any;
}, S = {
    [key: string]: any;
...
export declare type IRendererAppHelper = Partial<{
    /** 全局公共函数 */
...
export declare type IBaseRendererInstance = IGeneralComponent<IBaseRendererProps, Record<string, any>, any> & {
