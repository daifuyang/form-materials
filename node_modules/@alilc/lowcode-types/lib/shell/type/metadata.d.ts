 ...
 * 嵌套控制函数
 */
export declare type IPublicTypeNestingFilter = (testNode: any, currentNode: any) => boolean;
/**
 * 嵌套控制
...
export declare type ConfigureSupportEvent = string | ConfigureSupportEventConfig;
...
export interface IPublicTypeCallbacks {
    ...
    onResizeEnd?: (e: MouseEvent & {
        ...
        deltaX?: number;
        deltaY?: number;
    }, currentNode: IPublicModelNode) => void;
}
